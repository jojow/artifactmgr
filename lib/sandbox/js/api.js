    ...
    return function() {
        if (!process.stdin._apiCallbacks) {
            ...
            process.stdin.on('data',  function(data) {
                ...
                process.stdin._apiCallbacks[message.corr].apply(this, message.args);
        ...
        if (!_.isFunction(callback)) return exit({ _error: 'callback is not a function: ' + callback.toString() });
...
api.enrichHost = function(host) {
    return enrich(host, api.clartigr.access, true);
};
